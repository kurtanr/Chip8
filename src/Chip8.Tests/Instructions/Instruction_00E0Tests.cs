...
[TestFixture]
public class Instruction_00E0Tests : BaseInstructionTests
{
  [Test]
  public void Executing_Instruction_00E0_WorksAsExpected()
  {
    ...
    instruction.Execute(cpu, displayMock.Object, MockedKeyboard);
    ...
    Assert.That(instruction.ToStringWithDescription(), Is.EqualTo($"{"CLS",-18} // Clear the display."));
  }
}
